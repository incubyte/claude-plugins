...
These principles apply to ALL code Bee produces, evaluates, or cleans up — regardless of architecture pattern, language, or framework. They are non-negotiable defaults. The target project's AGENTS.md may add project-specific conventions on top of these.
...
**When the target project has its own AGENTS.md:**
