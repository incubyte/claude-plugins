...
This is additive — the agent's own question confirmation flow is unchanged. The collaboration loop is an additional gate in the orchestrator.
...
1. Agent writes document and confirms via question (existing flow)
