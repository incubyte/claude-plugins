...
- Document implicit conventions in AGENTS.md or code comments at the declaration site.
...
## AGENTS.md and Documentation Quality

AGENTS.md is the LLM's instruction manual for the project. If it's missing, outdated, or too vague, the LLM operates without project context and falls back to generic patterns that may not fit.

**What to check:**
- **Exists?** A missing AGENTS.md means the LLM has zero project-specific guidance.
...
**What to recommend:**
- Create a AGENTS.md if missing, with at minimum: tech stack, file structure, naming conventions, testing approach, and any non-obvious patterns.
- Update stale rules.
...
1. **High impact**: Missing types on public APIs, god files (1000+ lines), missing AGENTS.md, untested critical paths. These cause the most AI failures.
