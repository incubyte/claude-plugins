...
Use question with options: "Yes, that's right (Recommended)" / "Let me correct the paths"
...
**Question areas** (use question with concrete options drawn from the analysis):
...
Use question with options: "Yes, save it (Recommended)" / "Let me review the details first" / "Make changes before saving"
