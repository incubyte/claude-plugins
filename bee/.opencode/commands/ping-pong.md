...
4. **Present the plan.** Show the developer the ACs in the order you'll implement them (outside-in, ZOMBIE ordering within each AC). Use question: "Ready to start?" with options "Yes, let's go (Recommended)" / "I want to reorder".
