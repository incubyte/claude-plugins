...
Before starting, load these skills using the skill tool: `spec-writing`, `clean-code`, `design-fundamentals`.
...
Group 2-3 related questions together when they're about the same concern. Use question for choices. Use plain questions for open-ended clarifications.
