...
Before starting, load these skills using the skill tool: `design-fundamentals`, `clean-code`.
...
Adaptive interview — skip any topic answered by the auto-detected signals from Step 7. Use question with concrete options for each question.
...
Present the proposal to the developer before saving. Use question: "Here's the proposed design direction: [summary]. Save this to DESIGN.md?" Options: "Looks good, save it (Recommended)" / "I want to adjust something"
