...
Before starting, load these skills using the skill tool: `clean-code`, `architecture-patterns`.
...
After each section, present 2-3 multiple-choice questions via question.
