...
Before starting, load these skills using the skill tool: `architecture-patterns`, `clean-code`, `lsp-analysis`.
...
Use question to ask the developer:
...
- **Use question sparingly.** Only ask when docs and website are both unavailable or insufficient. Do not ask on every run.
