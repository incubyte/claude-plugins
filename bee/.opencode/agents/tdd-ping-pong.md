...
4. Present the plan to the developer:
   ...
   Use question: "Ready to start?" Options: "Yes, let's go (Recommended)" / "I want to reorder"
...
**Verify GREEN:** The coder will report status. If STUCK (couldn't make it pass after 3 tries), ask the developer for help via question.
