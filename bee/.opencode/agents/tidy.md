...
Before starting, load these skills using the skill tool: `clean-code`.
...
- **Escalate risky tidy tasks.** If a cleanup is large or risky (major refactor, wide rename), skip it and use question to flag it for the developer:
