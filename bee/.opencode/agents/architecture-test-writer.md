...
Before starting, load these skills using the skill tool: `architecture-patterns`, `clean-code`, `tdd-practices`, `lsp-analysis`.
...
If the framework is not present or unclear in the context-gatherer output, use question:
