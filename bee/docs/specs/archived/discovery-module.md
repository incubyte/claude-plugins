...
- [x] State file (`.claude/bee-state.local.md`) tracks a "discovery" phase between "context gathered" and "spec confirmed", including the path to the discovery document
